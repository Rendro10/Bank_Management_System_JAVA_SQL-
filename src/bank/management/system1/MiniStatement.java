...
public class MiniStatement extends JFrame {
    ...
    MiniStatement(String pinnumber){
        ...
        JLabel bank = new JLabel("Indian Banking Service");
        ...
        try{
            ...
            while(rs.next()){
                card.setText("Card Number: " + rs.getString("Account_number").substring(0,4)+"XXXXXXXX" +rs.getString("Account_number").substring(12) );
            }
